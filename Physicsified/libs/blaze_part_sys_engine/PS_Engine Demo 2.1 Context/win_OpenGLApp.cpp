...
bool COpenGLWinApp::createWindow(string sTitle)
{
	...
	if(!oglControl.initOpenGL(hInstance, &hWnd, 2, 1, initScene, renderScene, releaseScene, &oglControl))return false;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR sCmdLine, int iShow)
{
	...
	if(!appMain.createWindow("Particle System Demonstration"))
		return 0;
	appMain.resetTimer();
